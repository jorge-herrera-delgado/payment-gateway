...
namespace payment_gateway_test.ActionTest
{
    ...
    public class LoginActionTest
    {
        ...
        public void Init()
        {
            ...
            _mockUsService.Setup(s => s.Authenticate(It.IsAny<string>(), It.IsAny<string>(), true)).Returns(_userRepo);
        ...
        {
            //Arrange
            var action = new LoginAction(_mockUsService.Object, _mockValService.Object, _mockValManager.Object, _log);
            //Act
        ...
        public void LoginAction_ValidationService_Failed()
        {
            ...
            //Arrange
            var action = new LoginAction(_mockUsService.Object, mockValService.Object, _mockValManager.Object, _log);
            //Act
            var result = action.ProcessAction(_userApi.UserLogin).Result;
            //Assert
            Assert.IsNotNull(result);
